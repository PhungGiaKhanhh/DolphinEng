...
public class VocabularyItemActivity extends AppCompatActivity implements OnQuestionCallbackVocabularyItem {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hiển thị nút back trên thanh công cụ (Action Bar)
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);  // Thêm dòng này để bật nút mũi tên back
        ...
        switch (level) {
            ...
            case 2:
                ...
                break;
            default:
                btnNext.setText("Chuyen level tiep theo");
        }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (level == 0 || level == 1) {
                    ...
                    Vocabulary vc = vocabularyDatabase.getListVocabularyFromId(vocabulary.getIdVocabulary() + 1);
                    Intent intent = new Intent(VocabularyItemActivity.this, VocabularyItemActivity.class);
    ...
    // Xử lý sự kiện khi nhấn nút back (mũi tên)
    @Override
